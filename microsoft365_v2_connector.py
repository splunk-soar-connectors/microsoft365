# File: microsoft365_v2_connector.py
#
...
from microsoft365_v2_consts import (
    MICROSOFT365_V2_CONNECTIVITY_ENDPOINT,
    MICROSOFT365_V2_ERR_CONNECTIVITY_TEST,
    MICROSOFT365_V2_SUCC_CONNECTIVITY_TEST,
)


class Microsoft365_v2Connector(BaseConnector):
    """
    Microsoft365_v2 connector class that serves as a starting point for new connectors.
    """
    ...
    def _handle_test_connectivity(self, param):
        ...
        endpoint = MICROSOFT365_V2_CONNECTIVITY_ENDPOINT
        headers = {"Authorization": f"Bearer {self._api_key}"}

        ret_val, _ = self._make_rest_call(endpoint, action_result, headers=headers)

        if phantom.is_fail(ret_val):
            self.save_progress(MICROSOFT365_V2_ERR_CONNECTIVITY_TEST)
            return action_result.get_status()

        self.save_progress(MICROSOFT365_V2_SUCC_CONNECTIVITY_TEST)
...
if __name__ == "__main__":
    ...
    connector = Microsoft365_v2Connector()
